...
import { createBrowserHistory, createMemoryHistory, createHashHistory, History } from 'history';
...
import dynamic from 'dva/lib/dynamic';
...
export default function(opts = {}) {
  ...
  function start(container) {
    ...
    if (isString(container)) {
      ...
      invariant(domContainer, `[app.start] container ${domContainer} not found`);
    }
